...
IF record_exists_WMA_ID IS NOT NULL THEN UPDATE tblOpenChampWMAOverallPoints SET OpenChampCatMidWMAOverallPoints = total_points WHERE OpenChampWMAOverallPointsID = record_exists_WMA_ID;
ELSE INSERT INTO tblOpenChampWMAOverallPoints (RunnerID, OpenChampCatMidWMAOverallPoints, ChampionshipID, ChampYear) VALUES (runner_id, total_points, 1, champ_year);
END IF;
END