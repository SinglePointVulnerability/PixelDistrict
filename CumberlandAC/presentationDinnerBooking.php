...
?>
    <head>
      ...
      <title>Sorry, bookings are now closed! - Cumberland AC <?php echo $RaceYear;?></title>
        ...
        <div id="orangePaperBackground" class="orangePaperBackground">
                <form id="formPresDinnBook" name="formPresDinnBook" action="presentationDinnerBooking.php" method="post">
                    ...
                    <table>
                        <tr>
                            <th colspan="3">
                                Sorry, bookings are now closed! - Cumberland AC Presentation Dinner for the 2019-20 Season
                            </th>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <br>
                    <font style="color:black">Sorry, bookings are now closed!</font>
                </form>
            </div>
<?php
        }
