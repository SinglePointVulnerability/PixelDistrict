...
IF record_exists IS NOT NULL THEN UPDATE tblOpenChampLadiesOverallPoints SET OpenChampCatLongLadiesOverallPoints = total_points WHERE RunnerID = runner_id AND ChampYear = champ_year;
ELSE INSERT INTO tblOpenChampLadiesOverallPoints (RunnerID, OpenChampCatLongLadiesOverallPoints, ChampionshipID, ChampYear) VALUES (runner_id, total_points, 1, champ_year);
END IF;
END