...
function splitRunnerTimePoints($RaceIDTimePoints){
    ...
    if(strlen($RaceIDTimePoints) < 5) {
        ...
        if($champDisplay == "times") {
            ...
            return "<td><div class=\"fontRaceTime\" style='display:none'>$Pieces[1]</div><div class=\"fontRacePoints\" style='display:inline'>$Pieces[2]</div></td>\n";
        }
    }
}
